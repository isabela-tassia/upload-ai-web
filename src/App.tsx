    ...
    <div className='min-h-screen flex flex-col'>
      <div className="px-6 py-3 flex items-center justify-between border b">
        ...
        <div className="flex items-center gap-3">
          <span className="text-sm color text-muted-foreground">Desenvolvido com 💜 no NLW da Rocketseat</span>
        ...
        <aside className='w-80 space-y-6'>
          <form className='space-y-6'>
            ...
            <div className='space-y-2'>
              ...
              <Textarea id="transcription_prompt" className='h-20 leading-relaxed resize-none' placeholder='Inclua palavras-chave selecionadas no video separadas por virgula ( , )' />
            </div>
